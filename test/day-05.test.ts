...
import {solvePart1, solvePart2} from '../src/day-05';

describe('for Advent of Code Day#5', () => {
  it('should get the correct response for Part 1', async () => {
    const filepath = './inputs/day-05.txt';
    const answer = 'RTGWZTHLD';
